    ...
    return (
        <main className="w-full h-screen flex items-center justify-center flex-col">
            ...
            <div className="w-2/5 h-4/6 mt-4 p-10 flex justify-start flex-col bg-white border border-dotted border-[#c2c2c2] fixed rounded-md">
                ...
                <p className=" text-[#00000] text-xl mb-3">Una calculadora para métodos estudiados en el curso de análisis numérico en EAFIT.</p>
                <p className=" text-[#00000] text-xl mb-3">Recuerda leer muy bien las explicaciones de los métodos para poder ejecutarlos de manera correcta.</p>
